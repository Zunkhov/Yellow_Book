...
interface CategoriesProps {
  ...
  onCategoryClick?: (category: string) => void; // Optional now
}
...
export function Categories({ entries, onCategoryClick }: CategoriesProps) {
  ...
  const handleClick = (categoryName: string) => {
    if (onCategoryClick) {
      ...
      // Default: use Next.js routing
      router.push(`/companies?category=${encodeURIComponent(categoryName)}`);
    }
  };
